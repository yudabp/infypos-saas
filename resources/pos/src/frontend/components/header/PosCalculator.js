...
class PosCalculator extends React.Component {
    ...
    render() {
        const { display, operator, firstVal, secondVal } = this.state;
        const {
        ...
        return (
            <>
                <div className="calculator">
                    <CloseButton
                        className="bg-danger text-white border-0 position-absolute pos_calc_close"
                        onClick={this.props.opneCalculatorModel}
                    />
                    ...
                    <div className="inputs">
                        <div className="column main">
                            ...
                            <div className="numbers">
                                ...
                                <div className="">
                                    <button
                                        className=" btn-light text-black calc-btn-c"
                                        onClick={numberClickHandler}
                                    >
                                        0
                                    </button>
