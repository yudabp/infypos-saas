...
const CustomerForm = ( props ) => {
    const { show, hide, singleCustomer, addCustomer, setSelectedCustomerOption } = props
    ...
    const addCustomerData = ( formValue ) => {
        addCustomer( formValue, hide, setSelectedCustomerOption );
    };
                            ...
                            <Form>
                                <div className='row'>
                                    ...
                                    <ModelFooter onEditRecord={singleCustomer} onSubmit={onSubmit} editDisabled={disabled}
                                        addDisabled={!customerValue.name} link='/user/pos' modelhide={hide} />
                                </div>
                            </Form>
                        </div>
                    </div>
