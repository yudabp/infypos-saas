...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2025 at 09:23 AM
...
(1, 2, 1, NULL, 0, 0, 0, 1, '2025-07-24 09:17:26', '2025-07-31 23:59:59', NULL, 1, 0, NULL, '2025-07-24 03:47:26', '2025-07-24 03:47:26');
...
--
ALTER TABLE `payment_methods`
  ADD CONSTRAINT `payment_methods_tenant_id_foreign` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
