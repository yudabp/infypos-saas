...
return [
    ...
    */
    ...
    | usando la convención "attribute.regla" para nombrar las líneas. Esto hace que
    | sea rápido especificar una línea de idioma personalizada para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para reemplazar el marcador de posición
    | del atributo con algo más amigable para el lector, como "Dirección de correo electrónico"
